...
2. https://github.com/Riku4230/Nudge/security/advisories/new
...
Nudge は OSS で配布される macOS アプリのため、以下を理解した上でご利用ください。

| 項目 | 状態 |
|---|---|
| **コード署名** | 現在は未署名。初回起動時は Gatekeeper の許可操作が必要です |
...
セキュリティ以外の問い合わせは [GitHub Issues](https://github.com/Riku4230/Nudge/issues) へ。
